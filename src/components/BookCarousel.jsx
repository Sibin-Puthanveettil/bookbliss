  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography id="new-arrivals-title" variant="h4" component="h2" align="center" gutterBottom>
            New Arrivals
          </Typography>
          <Box sx={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
            {newArrivals.map((book, index) => (
              <Box key={index} sx={{ textAlign: 'center', margin: '10px' }}>
                <img src={book.img} alt={`New Arrival ${index + 1}`} style={{ width: '100%', maxWidth: '150px' }} />
