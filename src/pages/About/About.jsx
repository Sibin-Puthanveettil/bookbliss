...
import { AppBar, Toolbar, Typography, Container, Grid, Card, CardMedia, CardContent, IconButton } from '@mui/material';
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ my: 3, py: 3 }}>
        <Typography variant="h4" align="center" gutterBottom>About The Book Bliss</Typography>
        <hr />
        ...
        {/* Follow Us Section */}
        <Typography variant="h5" align="center" gutterBottom sx={{ mt: 5 }}>Follow Us</Typography>
        <Grid container justifyContent="center" spacing={2}>
          <Grid item>
            <Button
              ...
              target="_blank"
              startIcon={<Facebook />}
              sx={{ backgroundColor: '#3b5998', '&:hover': { backgroundColor: '#2d4373' } }} // Facebook color
            >
              Facebook
            </Button>
          </Grid>
          <Grid item>
            <Button
              ...
              target="_blank"
              startIcon={<Instagram />}
              sx={{ backgroundColor: '#E1306C', '&:hover': { backgroundColor: '#C13584' } }} // Instagram color
            >
              Instagram
            </Button>
          </Grid>
          <Grid item>
            <Button
              ...
              target="_blank"
              startIcon={<LinkedIn />}
              sx={{ backgroundColor: '#0077B5', '&:hover': { backgroundColor: '#005582' } , color:'white'}} // LinkedIn color
            >
              LinkedIn
            </Button>
          </Grid>
        </Grid>
        <Typography variant="h5" align="center" gutterBottom sx={{ mt: 5 }}>Reach Us</Typography>
        <Grid container justifyContent="center">
          <Grid item xs={12} md={8}>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3924.2821606547873!2d76.11457659999999!3d10.3991498!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7f49ea786b6f5%3A0x117573c2f22a4644!2sManappuram%20Finance%20Limited%20-%20Head%20Office!5e0!3m2!1sen!2sin!4v1727436236936!5m2!1sen!2sin" width="100%" height="250" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </Grid>
        </Grid>
