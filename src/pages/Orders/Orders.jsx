        ...
        <div style={styles.container}>  
            ...
            {orders.length > 0 ? (  
                orders.map(order => (  
                    ...
                    >  
                        <img src={'https://getmybooks.sgp1.cdn.digitaloceanspaces.com/images/33634959_1.jpg'} alt={order.title} style={styles.image} />  
                        <div style={styles.orderDetails}>  
                            <div>  
                                <h3>{order.title}</h3>  
                                <p>Author: {order.author}</p>  
                                <p>Publication Year: {order.publication_year}</p>  
                                <p>Genre: {order.genre.join(', ')}</p>  
